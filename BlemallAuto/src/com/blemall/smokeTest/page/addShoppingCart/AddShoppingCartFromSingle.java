...
public class AddShoppingCartFromSingle extends Page{

	public AddShoppingCartFromSingle(WebDriver driver) throws IOException {
		super(driver);
	}
	@Test(dataProvider = "providerMethod")
	public void addShoppingCart1(Map<String,String> param) throws IOException{
		System.out.println("Hello Merry！");
		AddShoppingCartFromSingle as=new AddShoppingCartFromSingle(driver);
